...
export default function Admin() {
  ...
  if (!autorizado) {
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="w-full max-w-sm rounded-xl border border-border-hairline bg-bg-card shadow-soft p-8">
  ...
  return (
    <div className="max-w-shell mx-auto px-6 md:px-10 py-10">
      ...
      <div className="mt-8 rounded-xl border border-border-hairline bg-bg-card shadow-soft p-5">
      ...
      <div className="mt-6 rounded-xl border border-border-hairline bg-bg-card shadow-soft p-5">
