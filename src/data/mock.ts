...
export const customers: Customer[] = [
  {
    ...
    employment: {
      kind: 'dependiente',
      employer: 'Servicios Andinos Limitada',
...
const FRANCISCO_DOCS: Document[] = [
  {
    ...
    status: 'validado',
    uploadedAt: '2026-08-18T09:21:00-04:00',
    validatedAt: '2026-08-18T09:22:00-04:00',
    uploadedBy: 'cliente',
    extractedData: {
      rut: '16.482.930-7',
  ...
  },
  {
    ...
    status: 'validado',
    uploadedAt: '2026-08-19T11:15:00-04:00',
    validatedAt: '2026-08-19T11:45:00-04:00',
    uploadedBy: 'cliente',
    extractedData: {
  ...
  },
  {
    ...
    status: 'validado',
    uploadedAt: '2026-09-03T15:20:00-04:00',
    validatedAt: '2026-09-03T15:38:00-04:00',
    uploadedBy: 'cliente',
    extractedData: {
...
const FRANCISCO_TIMELINE: TimelineEvent[] = [
  {
    ...
    actor: { kind: 'cliente', name: BRAND.buyerName, id: 'CUS-001' },
  ...
  },
  {
    id: 'EV-0042-03',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-08-15T14:30:00-04:00',
    actor: { kind: 'cliente', name: BRAND.buyerName, id: 'CUS-001' },
    type: 'firma_contrato',
  ...
  },
  {
    id: 'EV-0042-04',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-08-18T09:20:00-04:00',
    actor: { kind: 'cliente', name: BRAND.buyerName, id: 'CUS-001' },
    type: 'solicitud_creada',
  ...
  },
  {
    id: 'EV-0042-05',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-08-18T09:22:00-04:00',
    actor: { kind: 'agente' },
  ...
  },
  {
    id: 'EV-0042-06',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-08-19T11:15:00-04:00',
    actor: { kind: 'cliente', name: BRAND.buyerName, id: 'CUS-001' },
  ...
  },
  {
    id: 'EV-0042-07',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-08-19T11:45:00-04:00',
    actor: { kind: 'agente' },
  ...
  },
  {
    id: 'EV-0042-08',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-08-20T16:30:00-04:00',
    actor: { kind: 'agente' },
    type: 'cruce_bureau',
  ...
  },
  {
    id: 'EV-0042-09',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-08-22T10:00:00-04:00',
  ...
  },
  {
    id: 'EV-0042-10',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-09-03T15:20:00-04:00',
    actor: { kind: 'cliente', name: BRAND.buyerName, id: 'CUS-001' },
    type: 'documento_subido',
  ...
  },
  {
    id: 'EV-0042-11',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-09-12T10:30:00-04:00',
    actor: { kind: 'ejecutivo', name: 'Camila Reinoso Pereira', id: 'EXE-001' },
  ...
  },
  {
    id: 'EV-0042-12',
    caseId: 'HIP-2026-0042',
    timestamp: '2026-09-14T16:45:00-04:00',
    actor: { kind: 'agente' },
    type: 'observacion_ia',
...
const FRANCISCO_CASE: Case = {
  ...
  promesa: {
    signedAt: '2026-08-15T14:30:00-04:00',
    amountUF: 340,
    notary: BRAND.notariaName,
    reference: 'Repertorio 2026-04788',
  },
  createdAt: '2026-08-18T09:20:00-04:00',
  updatedAt: '2026-09-14T16:45:00-04:00',
...
function docsDeApoyo(caseId: string, semilla: number): Document[] {
  ...
  return PLANTILLA_DOCS.map((d, i) => {
    ...
    return {
      ...
      label: d.label,
      status,
      uploadedAt: subido ? `2026-09-${String(1 + i + semilla).padStart(2, '0')}T10:20:00-04:00` : undefined,
      validatedAt: status === 'validado' ? `2026-09-${String(3 + i + semilla).padStart(2, '0')}T11:05:00-04:00` : undefined,
...
const OTHER_CASES: Case[] = [
  {
    ...
    updatedAt: '2026-09-14T09:10:00-04:00',
  ...
  },
  {
    ...
    updatedAt: '2026-09-14T17:45:00-04:00',
  ...
  },
  {
    ...
    createdAt: '2026-08-28T14:10:00-04:00',
    updatedAt: '2026-09-14T11:22:00-04:00',
  ...
  },
  {
    ...
    createdAt: '2026-09-02T10:30:00-04:00',
    updatedAt: '2026-09-14T08:45:00-04:00',
...
export const communications: Communication[] = [
  ...
  },
  {
    ...
    caseId: 'HIP-2026-0042',
    kind: 'sms',
    date: '2026-08-22T10:02:00-04:00',
    from: BRAND.shortName,
  ...
  },
  {
    ...
    caseId: 'HIP-2026-0042',
    kind: 'email',
    date: '2026-09-12T10:32:00-04:00',
