...
export const BANK_THEMES: Record<string, BankTheme> = {
  ...
  itau: { ...BASE, slug: 'itau', name: 'Itaú', shortName: 'Itaú', legalName: 'Banco Itaú Chile', accent: '#EC7000', accentMuted: '#C85E00', accentSoft: '#FEF0E5', fontFamily: "'Inter', sans-serif", assistantName: 'Alicia' },
  scotiabank: { ...BASE, slug: 'scotiabank', name: 'Scotiabank', shortName: 'Scotiabank', legalName: 'Scotiabank Chile', accent: '#EC111A', accentMuted: '#C40E16', accentSoft: '#FDECED', fontFamily: "'Montserrat', sans-serif", assistantName: 'Sofía' },
  ...
  bci: { ...BASE, slug: 'bci', name: 'Bci', shortName: 'Bci', legalName: 'Banco de Crédito e Inversiones', accent: '#002F87', accentMuted: '#00246A', accentSoft: '#E7ECF6', fontFamily: "'Inter', sans-serif", assistantName: 'Trinidad' },
